...
> [!IMPORTANT]
> It is **important** to note that to use iTunes Connect, and therefore publish an app to the App Store, you **must** be part of either an individual or organizational Apple Developer Program. You will not be able to follow the steps on this page if you are not a member of an Apple Developer **Enterprise** Program.
